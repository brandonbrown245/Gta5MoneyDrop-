...
setTimeout(() => {
  if(!message.member.roles.find(r => r.name == "Unregistered")) return member.sendMessage(`**Please, To get in you have to register your Social Club name on this server by doing **>register Then your social club name** in the #register chat, if you dont in the next minutes you will be kicked**`)
 }, 30000);
 
 setTimeout(() => {
  if(!message.member.roles.find(r => r.name == "Money Unregistered")) return  member.kick('')
